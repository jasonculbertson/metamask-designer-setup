...
- **Direct link (v1.0.3):** [MetaMask-Designer-Setup-1.0.3-arm64.dmg](https://github.com/jasonculbertson/metamask-designer-setup/releases/download/v1.0.3/MetaMask-Designer-Setup-1.0.3-arm64.dmg)
